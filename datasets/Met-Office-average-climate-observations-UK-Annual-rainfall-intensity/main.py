...
df.to_csv(out/'rain-intensity.csv', index = False)
...
csvw_mapping.set_csv(out/"rain-intensity.csv")
csvw_mapping.set_dataset_uri(f"http://gss-data.org.uk/data/gss_data/climate-change/{info_json['id']}")
csvw_mapping.write(out/'rain-intensity.csv-metadata.json')

shutil.copy("rain-intensity.csv-metadata.trig", out/"rain-intensity.csv-metadata.trig")
