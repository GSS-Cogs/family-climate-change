...
df.to_csv(out/'rainfall-95pc.csv', index = False)
...
csvw_mapping.set_csv(out/"rainfall-95pc.csv")
csvw_mapping.set_dataset_uri(f"http://gss-data.org.uk/data/gss_data/climate-change/{info_json['id']}")
csvw_mapping.write(out/'rainfall-95pc.csv-metadata.json')

shutil.copy("rainfall-95pc.csv-metadata.trig", out/"rainfall-95pc.csv-metadata.trig")
