...
df.to_csv(out/'annual-rainfall-95.csv', index = False)
...
csvw_mapping.set_csv(out/"annual-rainfall-95.csv")
csvw_mapping.set_dataset_uri(f"http://gss-data.org.uk/data/gss_data/climate-change/{info_json['id']}")
csvw_mapping.write(out/'annual-rainfall-95.csv-metadata.json')

shutil.copy("annual-rainfall-95.csv-metadata.trig", out/"annual-rainfall-95.csv-metadata.trig")
