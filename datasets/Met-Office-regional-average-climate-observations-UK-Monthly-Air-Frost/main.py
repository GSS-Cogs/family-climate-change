...
df.to_csv(out/'monthly-air-frost.csv', index = False)
...
csvw_mapping.set_csv(out/"monthly-air-frost.csv")
csvw_mapping.set_dataset_uri(f"http://gss-data.org.uk/data/gss_data/climate-change/{info_json['id']}")
csvw_mapping.write(out/'monthly-air-frost.csv-metadata.json')

shutil.copy("monthly-air-frost.csv-metadata.trig", out/"monthly-air-frost.csv-metadata.trig")
