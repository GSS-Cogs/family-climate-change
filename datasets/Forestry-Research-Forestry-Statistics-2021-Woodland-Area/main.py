...
df.to_csv(out/'woodland-area.csv', index = False)
...
csvw_mapping.set_csv(out/"woodland-area.csv")
csvw_mapping.set_dataset_uri(f"http://gss-data.org.uk/data/gss_data/climate-change/{info_json['id']}")
csvw_mapping.write(out/'woodland-area.csv-metadata.json')

shutil.copy("woodland-area.csv-metadata.trig", out/"woodland-area.csv-metadata.trig")
