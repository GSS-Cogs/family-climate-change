...
df.to_csv(out/'summer-days.csv', index = False)
...
csvw_mapping.set_csv(out/"summer-days.csv")
csvw_mapping.set_dataset_uri(f"http://gss-data.org.uk/data/gss_data/climate-change/{info_json['id']}")
csvw_mapping.write(out/'summer-days.csv-metadata.json')

shutil.copy("summer-days.csv-metadata.trig", out/"summer-days.csv-metadata.trig")
