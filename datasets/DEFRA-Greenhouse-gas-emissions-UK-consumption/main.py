...
df['GHG generated directly from UK households'] = df['UK Households heating emissions arising from the use of fossil fuels'] + \
    df['UK Transport emissions generated directly by UK households']

df.drop(columns=['UK Households heating emissions arising from the use of fossil fuels',
        'UK Transport emissions generated directly by UK households'], axis=1, inplace=True)
...
df = pd.melt(df, id_vars=['Year'],
             value_vars=['GHG from UK produced goods and services',
                         'GHG embedded in imported goods and services', 'GHG generated directly from UK households'],
