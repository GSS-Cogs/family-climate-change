...
df.to_csv(out/'icing-days.csv', index = False)
...
csvw_mapping.set_csv(out/"icing-days.csv")
csvw_mapping.set_dataset_uri(f"http://gss-data.org.uk/data/gss_data/climate-change/{info_json['id']}")
csvw_mapping.write(out/'icing-days.csv-metadata.json')

shutil.copy("icing-days.csv-metadata.trig", out/"icing-days.csv-metadata.trig")
