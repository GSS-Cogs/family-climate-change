...
df.to_csv(out/'rain-days-99.csv', index = False)
...
csvw_mapping.set_csv(out/"rain-days-99.csv")
csvw_mapping.set_dataset_uri(f"http://gss-data.org.uk/data/gss_data/climate-change/{info_json['id']}")
csvw_mapping.write(out/'rain-days-99.csv-metadata.json')

shutil.copy("rain-days-99.csv-metadata.trig", out/"rain-days-99.csv-metadata.trig")
