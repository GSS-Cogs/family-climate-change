...
df.to_csv(out/'monthly-rain.csv', index = False)
...
csvw_mapping.set_csv(out/"monthly-rain.csv")
csvw_mapping.set_dataset_uri(f"http://gss-data.org.uk/data/gss_data/climate-change/{info_json['id']}")
csvw_mapping.write(out/'monthly-rain.csv-metadata.json')

shutil.copy("monthly-rain.csv-metadata.trig", out/"monthly-rain.csv-metadata.trig")
