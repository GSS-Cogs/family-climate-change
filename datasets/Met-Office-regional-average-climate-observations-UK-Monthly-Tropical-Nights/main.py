...
df.to_csv(out/'tropical-nights.csv', index = False)
...
csvw_mapping.set_csv(out/"tropical-nights.csv")
csvw_mapping.set_dataset_uri(f"http://gss-data.org.uk/data/gss_data/climate-change/{info_json['id']}")
csvw_mapping.write(out/'tropical-nights.csv-metadata.json')

shutil.copy("tropical-nights.csv-metadata.trig", out/"tropical-nights.csv-metadata.trig")
